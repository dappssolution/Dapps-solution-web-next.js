...
const logoVariants: Variants = {
	...
	hover: { rotateY: 15, scale: 1.12, boxShadow: "0 0 32px 0 #E1AAFF" },
};
		...
		<div className="absolute inset-0 bg-black/50 z-10" />
			...
			{/* Headline */}
			   <motion.h1
				   ...
				   initial="initial"
				   animate="animate"
				   className="font-extrabold text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight md:leading-[1.1] drop-shadow-2xl flex flex-col items-center gap-3 z-20"
				   style={{ perspective: 800, color: '#E1AAFF', textShadow: '0 8px 32px #3D096C99' }}
			   >
				   <span
					   className="block"
					   style={{
				   ...
				   <span className="flex items-center justify-center gap-3">
					   ...
					   >
						  ...
						  <span
						   style={{
							   background: 'linear-gradient(90deg, #3D096C 0%, #A43EF9 100%)',
							   WebkitBackgroundClip: 'text',
							   WebkitTextFillColor: 'transparent',
							   fontWeight: 900,
			...
			{/* Short Tagline Below */}
			   <motion.p
				   ...
				   style={{
					   ...
					   textShadow: '0 2px 12px #3D096C88',
				   }}
			   >
