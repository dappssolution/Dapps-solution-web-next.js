...
export default function SocialRelatedWorks() {
  ...
  // Sample data for the related works grid - using social projects
  const relatedWorks = [
    {
      id: 402,
    ...
    },
    {
      ...
      category: "social",
      route: "/works/greens-door-organics",
    },
    {
      id: 408,
